...
* (Bug) Quitting chrome and opening it again resets the time limit. This is because background.js reruns.
...
* (Feature) Modify code so time-limit resets when the date tracks over